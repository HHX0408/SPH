...
Tester::Tester(const char *windowTitle,int argc,char **argv) {
	...
	//init SPH system
	sphSystem = new SPHSystem(20, 0.02f, 1000, 1, 1.0f, 0.15f, -9.8f, 0.9f);
}
...
void Tester::Draw() {
	...
	ImGui_ImplGLUT_NewFrame();
	{
		...
		ImGui::Text("Press space to start simulation and r to reset.");
		...
		//ImGui::SliderFloat("Surface Tension",&tension, 0.001f, 1.f);
